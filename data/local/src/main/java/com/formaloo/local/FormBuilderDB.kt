...
@Database(
    entities = [Board::class, Form::class, Block::class, Speaker::class, Restaurant::class, News::class, NewsKeys::class, TimeLine::class, TimeLineKeys::class, FAQ::class, FAQKeys::class, RestaurantsKeys::class, SpeakersKeys::class],
    version = 1,
    exportSchema = false
)
...
abstract class FormBuilderDB : RoomDatabase() {
    ...
    abstract fun sponsorKeysDao(): RestaurantKeysDao
